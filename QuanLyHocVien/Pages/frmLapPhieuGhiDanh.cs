...
namespace QuanLyHocVien.Pages
{
    public partial class frmLapPhieuGhiDanh : Form
    {
        ...
        private void lblTongCongHV_Click(object sender, EventArgs e)
        {
        ...
        private void numConNo_ValueChanged(object sender, EventArgs e)
        {
        ...
        private void numHocPhi_ValueChanged(object sender, EventArgs e)
        {

        }

        private void dateNgayGhiDanh_ValueChanged(object sender, EventArgs e)
        {
        ...
        private void lblTongCongPhieu_Click(object sender, EventArgs e)
        {
        ...
        private void gridPhieuGhiDanh_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
