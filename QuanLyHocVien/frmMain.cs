...
namespace QuanLyHocVien
{
    public partial class frmMain : Form
    {
        ...
        {
            SetButtonTitleStyle(btnNhanVienTitle, Color.Black, Color.White);
            SetButtonTitleStyle(btnGiangVienTitle, Color.Black, Color.White);
            SetButtonTitleStyle(btnHocVienTitle, Color.Black, Color.White);
            SetButtonTitleStyle(btnQuanTriTitle, Color.Black, Color.White);
        }

        private static void SetButtonTitleStyle(Button btn, Color backColor, Color foreColor)
        {
